...
function getCommonCharacterCount(s1, s2) {
  ...
  // Iterate over one frequency map to check common characters
  for (const char in frequencyMap1) {
      if (frequencyMap2.hasOwnProperty(char)) {
          // Increment commonCount by the minimum occurrences of the character
